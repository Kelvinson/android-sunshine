...
//        };
    ...
    private  void loadWeatherData () {
        ...
        new networkRequestTask().execute(location);
    }
    ...
    public class networkRequestTask extends AsyncTask <String, Void, String[]> {
        ...
        @Override
        protected void onPostExecute(String[] urlSearchResults) {
            if (urlSearchResults != null ) {
                for (String searchResult : urlSearchResults) {
                    mWeatherTextView.append(searchResult+"\n\n\n");
                }
            }
        }
    }
